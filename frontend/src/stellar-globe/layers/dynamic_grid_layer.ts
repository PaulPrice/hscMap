...
if (BUILD_SETTINGS.RUN_TEST) (function spec() {
    console.assert(isEqual(parseAngleText('1.5deg'), [math.deg2rad(1.5), '1.5&deg;']))
    console.assert(isEqual(parseAngleText('4.5arcmin'), [math.arcmin2rad(4.5), '4.5&prime;']))
    console.assert(isEqual(parseAngleText('27arcsec'), [math.arcsec2rad(27), '27&Prime;']))
})()


function isEqual(a: any, b: any) {
    const typeof_a = a === null ? 'null' : typeof a
    const typeof_b = b === null ? 'null' : typeof b
