...
import MenuBarItem from './menu_bar_item.vue'
...
<style lang="sass" scoped>
    .menu-bar
        ...
        background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(31, 31, 31, 0.125)), to(rgba(0, 0, 0, 0.25)))
